...
const metrics = [
  { label: 'Carbon Offset', value: 1247, unit: 'tons CO₂', target: 2000, icon: Cloud, color: '#22c55e' },
  { label: 'Water Saved', value: 3400000, unit: 'liters', target: 5000000, icon: Droplets, color: '#06b6d4' },
  { label: 'Energy Saved', value: 2340, unit: 'MWh', target: 4000, icon: Zap, color: '#f59e0b' },
  { label: 'Waste Recycled', value: 78, unit: '%', target: 90, icon: Recycle, color: '#8b5cf6' },
...
export default function SustainabilityDashboardPage() {
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold font-heading">Sustainability Dashboard</h1>
      ...
      >
        {metrics.map((metric) => {
          ...
          return (
            <motion.div key={metric.label} variants={staggerItem} className="glass rounded-xl p-5 text-center">
              <div className="w-10 h-10 rounded-xl mx-auto mb-3 flex items-center justify-center" style={{ background: `${metric.color}15` }}>
      ...
      <div className="glass rounded-xl p-5">
        <h3 className="font-heading font-semibold text-sm mb-4">Sustainability Trend — Tournament Period</h3>
